...
static const char *fonts[]          = { "JetBrainsMono NFM:size=18:style=Bold:antialias=true:autohint=true" };
static const char dmenufont[]       = "JetBrainsMono NFM:size=18:style=Bold:antialias=true:autohint=true";
